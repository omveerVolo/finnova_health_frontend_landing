<script lang="ts">
	...
	const faqs = [
		...
		},
		{
			...
			answer: 'Yes. You can prepay your loan at any time without penalty or pre-closure charges.'
		},
		{
			id: 11,
		...
		},
		{
			...
			answer: 'No-cost EMI and low cost EMI options are available with Finnova.'
		},
		{
			id: 14,
...
<section id="faq-hospitals" class="w-full bg-white px-6 py-24 lg:px-16">
	<div class="mx-auto max-w-[1000px]">
		<div class="mb-16 text-center">
			<div
				class="mb-4 inline-flex items-center gap-2 rounded-full border border-brand/10 bg-brand/5 px-4 py-1"
			>
			...
			<h3 class="text-4xl font-bold tracking-tight text-brand-deep lg:text-5xl">
				FAQ for <span class="text-brand">Patients</span>
			</h3>
		</div>
